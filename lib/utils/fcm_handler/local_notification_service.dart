...
//       // Re-show notification (Android collapses reply UI)
//       if (_lastTitle != null) {
...
//       return file.path;
//     } catch (e) {
//       print("❌ Avatar failed in terminated: $e");
//       return null;
//     }
//   }
...
//     final title =
//         msg.data['senderName'] ?? msg.notification?.title ?? "New Message";

//     final body = msg.data['message'] ?? msg.notification?.body ?? "Message";
