...
class FileDeepView extends StatefulWidget {
  ...
  @override
  State<FileDeepView> createState() => _FileDeepViewState();
}
...
class _FileDeepViewState extends State<FileDeepView> {
  ...
  Widget _buildDriveLayout(List<FolderinsideModel> folders, bool ismore) {
    return Column(
      children: [
        Container(
                          ...
                          BottomSheetOption(
                            ...
                            onTap: () {
                              showMoveToBinDialog(context, () {
                                ...
                                final insideBloc = context.read<InsideBloc>();
                                insideBloc.add(
                                  InMoveToTrashEvent(
                                    fileIDs: ids,
                                    selectedId: widget.fileId,
  ...
  Widget _buildFolderList(List<FolderinsideModel> folders, bool ismore) {
  ...
  Widget _buildFolderGrid(List<FolderinsideModel> folders, bool ismore) {
...
class _FolderGridItem extends StatelessWidget {
  final FolderinsideModel folder;
                                  ...
                                  [
                                    ...
                                    BottomSheetOption(
                                      ...
                                      onTap: () {
                                        showMoveToBinDialog(context, () {
                                          final insideBloc =
                                              context.read<InsideBloc>();
                                          insideBloc.add(InMoveToTrashEvent(
                                              fileIDs: [folder.id],
                                              selectedId: currentId));
                                          Messenger.alertAction(
                                            color: Colors.green,
                        ...
                        children: folder.labels
                            .map(
                              (label) => Chip(
                                ...
                                backgroundColor:
                                    _parseColor(label.color, folder),
...
Color _parseColor(String hexColor, FolderinsideModel folder) {
  try {
