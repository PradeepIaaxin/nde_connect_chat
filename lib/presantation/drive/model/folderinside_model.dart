class FolderinsideModel {
  ...
  factory FolderinsideModel.fromJson(Map<String, dynamic> json) {
    return FolderinsideModel(
  ...
  @override
  int get hashCode =>
      id.hashCode ^ starred.hashCode ^ name.hashCode ^ updatedAt.hashCode;

  FolderinsideModel copyWith({
    String? id,
    String? userId,
    String? name,
    String? mimetype,
