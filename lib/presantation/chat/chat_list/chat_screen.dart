...
//       }
//     }
//     // Hide search bar when scrolling down past threshold
...
//     // Show filter chips when scrolling up near top
//     if (offset < 100 && offset < _lastScrollOffset) {
//       if (!_showFilterChips) {
//         setState(() => _showFilterChips = true);
//       }
//     }
//     // Hide filter chips when scrolling down
//     else if (offset > 150 && offset > _lastScrollOffset) {
//       if (_showFilterChips) {
...
//                 },
//               ),
//             if (_isSearching && selectedUsers.isEmpty)
//               IconButton(
//                 icon: const Icon(Icons.close, color: Colors.black),
//                 onPressed: () {
//                   setState(() {
...
//                     slivers: [
//                       // Search bar sliver (appears on scroll up)
//                       SliverToBoxAdapter(
...
//                       // Filter chips section (appears on scroll up near top)
//                       SliverToBoxAdapter(
//                         child: AnimatedContainer(
//                           duration: const Duration(milliseconds: 300),
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          surfaceTintColor: Colors.white, // Prevents color changes
          leading: longPressed
              ? IconButton(
                  icon: const Icon(Icons.close, color: Colors.black),
                  onPressed: _clearSelection,
            ...
            return Container(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  ...
                  // Filter chips section (ONLY shows when at top AND scrolling up)
                  SliverToBoxAdapter(
                    child: AnimatedContainer(
                      duration: const Duration(milliseconds: 300),
                      height: _showFilterChips ? 60 : 0,
